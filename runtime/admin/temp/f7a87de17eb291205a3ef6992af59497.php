<?php /*a:5:{s:47:"D:\tp\app\admin\view\index\user_controller.html";i:1623205850;s:37:"D:\tp\app\admin\view\common\head.html";i:1623718861;s:39:"D:\tp\app\admin\view\common\import.html";i:1623199543;s:37:"D:\tp\app\admin\view\common\foot.html";i:1623199543;s:44:"D:\tp\app\admin\view\common\addUserForm.html";i:1623199543;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<table class="table-box layui-table">
    ...
    <tbody>
        ...
        <!--不为空-->
        <?php if(is_array($userlist) || $userlist instanceof \think\Collection || $userlist instanceof \think\Paginator): if( count($userlist)==0 ) : echo "" ;else: foreach($userlist as $key=>$user): ?>
        <tr>
            <td><?php echo htmlentities($user->id); ?></td>
            <td><?php echo htmlentities($user->name); ?></td>
            <td><?php echo htmlentities($user->createtime); ?></td>
            <td><?php echo htmlentities($user->lastlogin); ?></td>
            <td>
                <div class="layui-btn-group">
                    <button class="layui-btn  layui-btn-xs" onclick="resetPwd('<?php echo htmlentities($user->id); ?>','<?php echo htmlentities($user->name); ?>')">重置密码</button>
                    <button class="layui-btn layui-btn-danger layui-btn-xs" onclick="delUser('<?php echo htmlentities($user->id); ?>','<?php echo htmlentities($user->name); ?>')">删除用户</button>
                </div>
            </td>
        </tr>
...
<script>
    ...
    <form class="layui-form" id="form">
        ...
        <div class="layui-form-item" style="text-align: center">
            <a class="layui-btn" onclick="userFormSubmit()">提交</a>
